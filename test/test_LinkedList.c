...
void xtest_LinkedListAddToTail_given_3_value_expect_next_item_inserted(void)
{
...
//tail-------------^                   tail--------------------^
//count = 2                            count = 3
void xtest_LinkedListAddToTail_given_2_value_expect_next_item_inserted(void)
{
    int value1 = 1, value2 = 2, value3 = 23;
    int *addr;
...
//count = 3                          count = 2
void xtest_LinkedListRemoveFromHead_given_item1_and_item2_and_item3_with_delete_item1_expected_left_item2_and_item3(void)
{
...
void xtest_recallPrevious_given_item1_item2_item3_then_recall_previous_2_time_expect_item1_display(void)
{
  char *buffer1 = "hello";
  char *buffer2 = "hi";
  char *buffer3 = "hey";
...
//tail-->item2                   tail->item2
void xtest_recallNext_given_item1_and_item2_recallNext_at_item2_expect_item1_display(void)
{
  char *buffer1 = "hello";
  char *buffer2 = "hi";
  char *string_return;
...
void xtest_recallNext_given_item1_and_item2_recallNext_at_item1_expect_item2_display(void)
{
  char *buffer1 = "hello";
  char *buffer2 = "hi";
  char *string_return;
...
//tail--/                              tail->item3
void xtest_recallNext_given_item1_item2_item3_recallNext_at_tem3_expect_item1_display(void)
{
  char *buffer1 = "hello";
  char *buffer2 = "hi";
  char *buffer3 = "hey";
...
void xtest_recallNext_given_item1_item2_item3_recallNext_at_item2_expect_item3_display(void)
{
  char *buffer1 = "hello";
  char *buffer2 = "hi";
  char *buffer3 = "hey";
...
void xtest_recallNext_given_item1_item2_item3_recallNext_at_item1_expect_item2_display(void)
{
  char *buffer1 = "hello";
  char *buffer2 = "hi";
  char *buffer3 = "hey";
